...
func (this *DeviceBootstrapPayloadModelSource) AppendToSlice(slicePtr any, bObj any) any {
	s := slicePtr.(*[]*iot.DeviceBootstrapPayload)
	*s = append(*s, bObj.(*iot.DeviceBootstrapPayload))
	return s
}
