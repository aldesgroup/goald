...
func (bo *Device) AddAndReturnAssociatedUsers(added goald.IUser) goald.IUser {
...
// setting this Device's parent
func (bo *Device) SetParent(parent goald.IBusinessObject) {
