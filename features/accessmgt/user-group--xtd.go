...
func (bo *UserGroup) AddAndReturnMembers(added goald.IUser) goald.IUser {
...
// setting this UserGroup's parent
func (bo *UserGroup) SetParent(parent goald.IBusinessObject) {
